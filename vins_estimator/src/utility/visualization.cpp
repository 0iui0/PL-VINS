...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header, Eigen::Vector3d loop_correct_t,
    ...
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR) {
        ...
        ofstream foutC("~/catkin_ws/src/PL-VINS/Trajactory/tum_fast_no_loop.txt", ios::app);
        ...
        ofstream foutC1("~/catkin_ws/src/PL-VINS/Trajactory/evo_fast_no_loop.txt", ios::app);
