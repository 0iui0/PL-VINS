...
void readParameters(ros::NodeHandle &n) {
    ...
    std::ofstream foutC("~/catkin_ws/EuRoC/PL-VINS/outout/tum_plvins.txt", std::ios::out);
    foutC.close();
    std::ofstream foutC1("~/catkin_ws/EuRoC/PL-VINS/outout/evo_plvins.txt", std::ios::out);
    foutC1.close();
